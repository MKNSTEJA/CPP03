...
/*   Updated: 2025/06/04 00:08:17 by kmummadi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main() {
  ...
  section("Test 7: Overkill and Invalid Revival");
  {
    ...
    overkill.takeDamage(150); // Kill it hard
  ...
  section("Test 9: Gate Keeper Mode");
  {
    ScavTrap guard("GateMaster");
    guard.guardGate();
  }
