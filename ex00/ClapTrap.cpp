...
/*   Updated: 2025/06/01 19:19:59 by kmummadi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap()
  ...
  std::string msg;
  msg = "Default constructor for instance \"" + _name + "\" called.\n";
...
ClapTrap::ClapTrap(std::string name)
  ...
  msg = "Parametrised constructor for instance \"" + _name + "\" called.\n";
  colorprint(msg, GREEN);
}
...
ClapTrap::ClapTrap(const ClapTrap &copy)
  ...
  msg = "Copy constructor for instance \"" + _name + "\" called.\n";
  colorprint(msg, GREEN);
}
...
ClapTrap &ClapTrap::operator=(const ClapTrap &copy) {
  ...
  msg = "Copy assignment overload called\n";
  colorprint(msg, GREEN);
  if (this != &copy) {
    _name = copy.getName();
    _attackdamage = copy.getAttackDamage();
...
ClapTrap::~ClapTrap() {
  ...
  msg = "Destructor for instance \"" + _name + "\" called.\n";
  colorprint(msg, GREEN);
}
